...
function Application({ profile, onSignedOut, locale, theme, onThemeChange, localePreference, onLocaleChange, t }) {
  ...
  const navigation = [["dashboard", "dashboard"], ["administrators", "administrators"], ["paid-users", "paidUsers"], ["transactions", "transactions"], ["reports", "reports"]];
  useEffect(() => {
