...
async def send_accommodation_card(bot: Bot, chat_id: int, listing: CrousListing, language: str, first_seen_at: datetime, *, available_again: bool = False, downloader: SafeImageDownloader | None = None) -> int:
