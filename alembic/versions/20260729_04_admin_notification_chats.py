...
def upgrade() -> None:
    ...
    op.create_index("ix_admin_notification_chats_telegram_chat_id", "admin_notification_chats", ["telegram_chat_id"], unique=True)


def downgrade() -> None:
    op.drop_index("ix_admin_notification_chats_telegram_chat_id", table_name="admin_notification_chats")
    op.drop_index("ix_admin_notification_chats_telegram_user_id", table_name="admin_notification_chats")
